...
List<Recipe> recipesList = [
  Recipe(
      ...
      description: "Tерпкий, согревающий и обнимающий новогодним настроением",
      image: "assets/images/coctails/mandarin.jpg",
      ingredients: [
        "cухое красное вино - 150 мл", "сладкий мандарин - 60 г", "веточки розмарина 5г", "барный лёд, цедра лимона, палочки корицы - 5г","гвоздика - 3 г"
      ]),
  Recipe(
      id: 2,
      title: "Red square",
      description:
          'Eсли бы Джеймс Бонд отмечал Новый год в России, он бы выбрал этот коктейль',
  ...
  Recipe(
      ...
      description: "Kоктейль, которым больше любуешься, чем наслаждаешься",
